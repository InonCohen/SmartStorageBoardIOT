...
void listDir(fs::FS &fs, const char * dirname, uint8_t levels, String chat_id){
    bot.sendMessage(chat_id, "Listing directory: ${dirname}", "");
...
void handleNewMessages(int numNewMessages) {
  ...
  for (int i=0; i<numNewMessages; i++) {
    ...
    if (text == "/start") {
      ...
      welcome += "/get_my_items to get your's items info \n";
      welcome += "/add_user to add user to the board \n";
      welcome += "/delete_user to remove user from the board \n";
      welcome += "/make_manager to make user a manager \n";
      welcome += "/add_item to add item to the board \n";
      welcome += "/delete_item to remove item from the board \n";
