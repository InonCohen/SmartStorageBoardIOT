...
// ezButton DoorSwitch(SWITCH_PIN);
ezButton ProxiSwitch(PROXI_PIN);

String uidString;

// void SwitchLoop(){
//     DoorSwitch.loop(); // MUST call the loop() function first
...
//   else
//     Serial.println("The door is still opened");
// }

// void ProxiLoop(){
//     ProxiSwitch.loop(); // MUST call the loop() function first

//   if (ProxiSwitch.isPressed())
//     Serial.println("The tool is returned");

//   if (ProxiSwitch.isReleased())
//     Serial.println("The tool is taken");

//   int state = ProxiSwitch.getState();
//   if (state != HIGH)
//     Serial.println("The tool is still missing");
//   else
//     Serial.println("The tool is still here");
...
void setup() {
  ...
  // ProxiSwitch.setDebounceTime(50);
}
